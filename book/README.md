...
|데이터베이스 인터널스|개발|2022.06.18~2022.08.22|6|개발|개인적으로 내용들이 너무 좋기는 했지만 너무 어려웠던 책.... 분산시스템에 대한 설명들, 사용되는 각종 알고리즘들은 좋았지만 각 알고리즘에 대한 상세 내용들은 좀 어려웠다. 이런것들을 처음에는 어떻게 구현들을 했을까 궁금하다. 단순 서비스 개발에 도움될 내용들은 아니고, 좀더 큰 시스템 디자인이나 분산 시스템에 대한 이해를 필요로 하는 사람들에게는 도움이 될거 같다.|
